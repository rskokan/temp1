package test.stockwatcher.client;
...
public class StockWatcher implements EntryPoint {
	...
	// Listen for keyboard events on the Add button
	...
	// Setup a timer to refresh the stocks
